          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <Button variant="outline" size="lg" className="rounded-full" asChild>
                <a href="#pricing">View Pro — $5/mo</a>
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-6xl px-4">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-3 text-muted-foreground">
              ...
              features for <span className="font-semibold text-foreground">$5</span> per month.
            </p>
          </div>
          <div className="mx-auto mt-12 grid max-w-4xl gap-6 md:grid-cols-2">
            ...
            <div className="relative rounded-2xl border-2 border-primary bg-card p-8 shadow-md">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Full-site analysis, competitor workflows, and more.
              </p>
              <ul className="mt-6 space-y-2 text-sm">
                {[
                  "Everything in Basic",
                  "Full crawl & auto-style analysis",
                  "Competitor & rank intelligence",
                ].map((t) => (
                  <li key={t} className="flex gap-2">
                    <Check className="mt-0.5 size-4 shrink-0 text-emerald-600" />
                    {t}
      ...
      <section className="border-b border-border bg-muted/30 py-16 md:py-20">
        <div className="mx-auto max-w-6xl px-4">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-3 text-muted-foreground">
              Save reports, sync dashboard tools, and manage your $5 Pro subscription from one
              workspace.
            </p>
